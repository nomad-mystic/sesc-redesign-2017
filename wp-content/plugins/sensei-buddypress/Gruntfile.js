...
module.exports = function ( grunt ) {
    ...
    grunt.initConfig( {
        ...
        checktextdomain: {
            options: {
                text_domain: [ 'sensei-buddypress', 'buddypress', 'bbpress', 'woothemes-sensei', 'wcvendors-pro', 'woocommerce' ], //Specify allowed domain(s)
        ...
        makepot: {
            target: {
                options: {
                    ...
                    potFilename: 'sensei-buddypress.pot', // Name of the POT file.
