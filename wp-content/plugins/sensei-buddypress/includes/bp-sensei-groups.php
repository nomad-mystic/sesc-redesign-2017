...
if ( ! class_exists( 'BuddyPress_Sensei_Groups' ) ) {
	...
	class BuddyPress_Sensei_Groups {
		...
		public function bp_sensei_group_discussion_button( ) {
			...
			$html = '<p class="bp-group-discussion"><a class="button" href="'. trailingslashit(home_url()).trailingslashit($bp->groups->root_slug).$group_data .'">'.__('Course Discussion','sensei-buddypress').'</a></p>';
