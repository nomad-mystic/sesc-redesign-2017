...
class BuddyPress_Sensei_Plugin {
    ...
    */
    ...
    public function setup_actions() {
        ...
        if( $bp ){
            ...
            add_action( 'bp_init', array( $this, 'load_group_extension_sensei_course'), 10 );
        }
    ...
    public function bp_sensei_enqueue_styles() {
        ...
        wp_enqueue_style( 'sensei-buddypress', $this->assets_url . '/css/sensei-buddypress.min.css', array(), BUDDYPRESS_SENSEI_PLUGIN_VERSION, 'all' );
        // JS > Main
        //wp_enqueue_script( 'sensei-buddypress', $this->assets_url . '/js/sensei-buddypress.js', array(), '1.1.1', true );
        wp_enqueue_script( 'sensei-buddypress', $this->assets_url . '/js/sensei-buddypress.min.js', array(), BUDDYPRESS_SENSEI_PLUGIN_VERSION, true );
    }
    ...
    */
    ...
    public function load_group_extension_sensei_course() {
        if ( bp_is_active('groups') ) {
            bp_register_group_extension( 'Group_Extension_Sensei_Course_Settings' );
        }
    }
