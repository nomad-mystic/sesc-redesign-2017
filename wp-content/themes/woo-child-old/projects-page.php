<?php
/**
 * Template Name: SESC Projects Page Three Col
 *
...
?>
		...
		<?php if ( is_active_sidebar( 'projects_page' ) ) : ?>
			<aside id="projectsSidebarNav" class="primary-sidebar widget-area leftColNav" role="complementary">
				<?php dynamic_sidebar( 'projects_page' ); ?>
