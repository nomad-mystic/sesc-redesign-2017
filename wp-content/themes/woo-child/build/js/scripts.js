...
jQuery(document).ready(function ($) {
	...
	// For the H4
	var IDEANavClickEvent = function IDEANavClickEvent() {
	...
	// for the H4
	var disabilityCategoriesClickEvent = function disabilityCategoriesClickEvent() {
		if ($disabilityNavDiv.hasClass('clicked')) {
	...
	var agenciesAdvocatesClickEvent = function agenciesAdvocatesClickEvent() {
		if ($agenciesAdvoNAVDiv.hasClass('clicked')) {
