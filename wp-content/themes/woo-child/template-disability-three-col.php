<?php
/**
 * Template Name: SESC Disability Categories Page Three Col
 *
...
?>
		...
		<?php if ( is_active_sidebar( 'disability_categories_page_nav' ) ) : ?>
			<aside id="disabilityCategoriesNav" class="primary-sidebar widget-area leftColNav" role="complementary">
				<?php dynamic_sidebar( 'disability_categories_page_nav' ); ?>
